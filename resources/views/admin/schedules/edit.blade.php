...
<div class="page-header">
    <div class="page-header-content">
        ...
        <p class="page-subtitle">Update movie screening schedule information</p>
        <div class="schedule-info-badge">
            <i class="icofont icofont-movie"></i>
            <span>Editing: <strong>{{ $schedule->movie->title }}</strong> - {{ \Carbon\Carbon::parse($schedule->show_date)->format('d M Y') }}</span>
        </div>
    ...
    <div class="form-card">
        ...
        <div class="warning-alert">
            ...
            <div class="warning-alert-content">
                ...
                <p>Changing schedule information may affect existing bookings and ticket sales. Please ensure all details are correct before updating. Consider notifying customers if there are significant changes to the date or time.</p>
            </div>
        </div>
